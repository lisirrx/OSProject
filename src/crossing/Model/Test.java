...
//
//        Road roadSN = new Road(Road.Type.Common, Road.Direction.S2N, new Position( 300, 0));
//        Road roadNS = new Road(Road.Type.Common, Road.Direction.N2S, new Position( 100, 800));
//
//
